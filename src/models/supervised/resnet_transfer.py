...
class FCNResnetTransfer(nn.Module):
    def __init__(self, input_channels, output_channels, scale_factor=50, **kwargs):
        ...
        self.model = torch.hub.load('pytorch/vision:v0.10.0', 'fcn_resnet101', weights=torchvision.models.segmentation.FCN_ResNet101_Weights.DEFAULT)
        ...
        self.model.classifier[4] = nn.Conv2d(512, output_channels, kernel_size=(1, 1), stride=(1, 1), bias=False)

        self.pool = nn.MaxPool2d(scale_factor, **kwargs)
